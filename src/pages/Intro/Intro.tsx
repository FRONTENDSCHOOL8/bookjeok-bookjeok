...
export function Intro() {
  ...
  return (
    <>
      ...
      >
        <div className="intro-animation absolute top-[30%] flex flex-col items-center gap-2">
          <Svg size={60} id="logo" />
          <h1 className="text-h-1-semibold">북적북적</h1>
        </div>
        <div className="absolute bottom-0 mx-auto flex h-[20%] w-56 flex-col items-center gap-4">
          <MainButton
            size="sm"
            className="view-around shadow-xl"
            to="/main/club"
            color="third"
          >
            둘러보기
          </MainButton>
          <div className="login-animation flex w-56 items-center gap-2">
            <MainButton
              size="sm"
